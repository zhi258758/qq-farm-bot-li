...
/** 默认数据目录（与 bot 一致：CAPTURE_DATA_DIR 优先，其次 bot 运行时数据目录） */
...
function parsePortRange(value: any, fallbackFrom: number, fallbackTo: number) {
...
function saveConfig(config: any, dataDir?: string) {
